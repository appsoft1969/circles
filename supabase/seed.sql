...
VALUES
  ...
  ('33333333-3333-4333-8333-333333333002', '22222222-2222-4222-8222-222222222201', NULL, '王小明', '聊天群成員', 'member', 'active', '11111111-1111-4111-8111-111111111111', now()),
  ...
  ('33333333-3333-4333-8333-333333333004', '22222222-2222-4222-8222-222222222201', NULL, '張志豪', '聊天群成員', 'member', 'active', '11111111-1111-4111-8111-111111111111', now()),
...
VALUES
  ('44444444-4444-4444-8444-444444444001', '22222222-2222-4222-8222-222222222201', 'group_buy', '11111111-1111-4111-8111-111111111111', NULL, '7月咖啡豆團購', '精選單品咖啡豆，接單後新鮮烘焙。請在結單前完成下單。', 'open', '2026-07-05 23:59:00+08', 'pg-coffee-demo', '轉帳或行動支付。團主確認後會標記付款狀態。', '面交取貨，地點由團主另行通知。', '{"purpose":"group_buy","chatGroupCompanion":true}'::jsonb, now()),
