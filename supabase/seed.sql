-- Demo data for the local Circles Postgres database.
...
VALUES
  ('11111111-1111-4111-8111-111111111111', 'Kevin', 'kevin@example.com', 'zh-TW', 'Asia/Taipei', '{"seed":true}'::jsonb)
...
VALUES
  ('22222222-2222-4222-8222-222222222201', '11111111-1111-4111-8111-111111111111', '咖啡豆團購圈', '每月一起買單品咖啡豆', 'invite_link', 'coffee-demo', '{"seed":true}'::jsonb),
  ('22222222-2222-4222-8222-222222222202', '11111111-1111-4111-8111-111111111111', '辦公室午餐圈', '公司中午訂餐、飲料、下午茶', 'invite_link', 'office-demo', '{"seed":true}'::jsonb),
  ('22222222-2222-4222-8222-222222222203', '11111111-1111-4111-8111-111111111111', '下班放鬆圈', 'KTV、聚餐、活動揪團', 'invite_link', 'friends-demo', '{"seed":true}'::jsonb),
  ('22222222-2222-4222-8222-222222222204', '11111111-1111-4111-8111-111111111111', '圈內小市集', '圈內成員偶爾分享自種蔬果、手作品或少量現貨', 'invite_link', 'market-demo', '{"seed":true,"visibility":"circle_only"}'::jsonb)
ON CONFLICT (id) DO UPDATE
...
VALUES
  ('33333333-3333-4333-8333-333333333001', '22222222-2222-4222-8222-222222222201', '11111111-1111-4111-8111-111111111111', 'Kevin', '圈主', 'owner', 'active', '11111111-1111-4111-8111-111111111111', now()),
  ('33333333-3333-4333-8333-333333333002', '22222222-2222-4222-8222-222222222201', NULL, '王小明', 'LINE 群成員', 'member', 'active', '11111111-1111-4111-8111-111111111111', now()),
  ('33333333-3333-4333-8333-333333333003', '22222222-2222-4222-8222-222222222201', NULL, '林怡君', '', 'member', 'active', '11111111-1111-4111-8111-111111111111', now()),
  ('33333333-3333-4333-8333-333333333004', '22222222-2222-4222-8222-222222222201', NULL, '張志豪', 'LINE 群成員', 'member', 'active', '11111111-1111-4111-8111-111111111111', now()),
  ('33333333-3333-4333-8333-333333333005', '22222222-2222-4222-8222-222222222201', NULL, '陳雅婷', '', 'member', 'active', '11111111-1111-4111-8111-111111111111', now()),
  ('33333333-3333-4333-8333-333333333006', '22222222-2222-4222-8222-222222222202', '11111111-1111-4111-8111-111111111111', 'Kevin', '圈主', 'owner', 'active', '11111111-1111-4111-8111-111111111111', now()),
  ('33333333-3333-4333-8333-333333333007', '22222222-2222-4222-8222-222222222202', NULL, '林小美', '訂餐窗口', 'admin', 'active', '11111111-1111-4111-8111-111111111111', now()),
  ('33333333-3333-4333-8333-333333333008', '22222222-2222-4222-8222-222222222202', NULL, '王大明', '', 'member', 'active', '11111111-1111-4111-8111-111111111111', now()),
  ('33333333-3333-4333-8333-333333333009', '22222222-2222-4222-8222-222222222202', NULL, '張小華', '', 'member', 'active', '11111111-1111-4111-8111-111111111111', now()),
  ('33333333-3333-4333-8333-333333333010', '22222222-2222-4222-8222-222222222202', NULL, '怡君', '', 'member', 'active', '11111111-1111-4111-8111-111111111111', now()),
  ('33333333-3333-4333-8333-333333333011', '22222222-2222-4222-8222-222222222203', '11111111-1111-4111-8111-111111111111', 'Kevin', '圈主', 'owner', 'active', '11111111-1111-4111-8111-111111111111', now()),
  ('33333333-3333-4333-8333-333333333012', '22222222-2222-4222-8222-222222222203', NULL, '王小明', '', 'member', 'active', '11111111-1111-4111-8111-111111111111', now()),
  ('33333333-3333-4333-8333-333333333013', '22222222-2222-4222-8222-222222222203', NULL, '林怡君', '', 'member', 'active', '11111111-1111-4111-8111-111111111111', now()),
  ('33333333-3333-4333-8333-333333333014', '22222222-2222-4222-8222-222222222203', NULL, '張志豪', '', 'member', 'active', '11111111-1111-4111-8111-111111111111', now()),
  ('33333333-3333-4333-8333-333333333015', '22222222-2222-4222-8222-222222222204', '11111111-1111-4111-8111-111111111111', 'Kevin', '圈主', 'owner', 'active', '11111111-1111-4111-8111-111111111111', now()),
  ('33333333-3333-4333-8333-333333333016', '22222222-2222-4222-8222-222222222204', NULL, '阿姨菜園', '可發起圈內販售', 'admin', 'active', '11111111-1111-4111-8111-111111111111', now()),
  ('33333333-3333-4333-8333-333333333017', '22222222-2222-4222-8222-222222222204', NULL, '手作小安', '可發起圈內販售', 'admin', 'active', '11111111-1111-4111-8111-111111111111', now()),
  ('33333333-3333-4333-8333-333333333018', '22222222-2222-4222-8222-222222222204', NULL, '林怡君', '', 'member', 'active', '11111111-1111-4111-8111-111111111111', now()),
  ('33333333-3333-4333-8333-333333333019', '22222222-2222-4222-8222-222222222204', NULL, '王小明', '', 'member', 'active', '11111111-1111-4111-8111-111111111111', now())
ON CONFLICT (id) DO UPDATE
SET display_name = EXCLUDED.display_name,
...
VALUES
  ('44444444-4444-4444-8444-444444444001', '22222222-2222-4222-8222-222222222201', 'group_buy', '11111111-1111-4111-8111-111111111111', NULL, '7月咖啡豆團購', '精選單品咖啡豆，接單後新鮮烘焙。請在結單前完成下單。', 'open', '2026-07-05 23:59:00+08', 'pg-coffee-demo', '轉帳或 LINE Pay。團主確認後會標記付款狀態。', '面交取貨，地點由團主另行通知。', '{"purpose":"group_buy","lineCompanion":true}'::jsonb, now()),
  ('44444444-4444-4444-8444-444444444002', '22222222-2222-4222-8222-222222222202', 'meal_order', '11111111-1111-4111-8111-111111111111', NULL, '今天午餐便當', '11:10 前填完。店家：港式燒臘便當。', 'open', '2026-06-29 11:10:00+08', 'pg-lunch-demo', '午餐到再統一轉帳給小美。', '12:10 到公司 6F 茶水間。', '{"restaurant":"港式燒臘便當","deliveryTime":"12:10"}'::jsonb, now()),
  ('44444444-4444-4444-8444-444444444003', '22222222-2222-4222-8222-222222222202', 'drink_order', '11111111-1111-4111-8111-111111111111', NULL, '下午手搖飲', '15:00 前填完。店家：春日茶室。', 'open', '2026-06-29 15:00:00+08', 'pg-drink-demo', '飲料到再轉帳。', '16:00 前台自取。', '{"shop":"春日茶室","fields":["甜度","冰塊","加料"]}'::jsonb, now()),
  ('44444444-4444-4444-8444-444444444004', '22222222-2222-4222-8222-222222222203', 'activity', '11111111-1111-4111-8111-111111111111', NULL, '週五下班 KTV', '先統計人數，滿 6 人就訂包廂。', 'open', '2026-07-03 18:00:00+08', 'pg-ktv-demo', '現場 AA，若需訂金再通知。', '地點：西門錢櫃或好樂迪，依投票結果。', '{"locationOptions":["西門錢櫃","西門好樂迪"],"deposit":0}'::jsonb, now()),
  ('44444444-4444-4444-8444-444444444005', '22222222-2222-4222-8222-222222222204', 'member_sale', '11111111-1111-4111-8111-111111111111', '阿姨菜園 / 手作小安', '週末自種蔬菜與手作品', '圈內成員少量分享，先登記數量，採收或製作完成後通知付款取貨。', 'open', '2026-07-04 20:00:00+08', 'pg-market-demo', '確認有貨後再轉帳給販售者，管理者協助標記付款。', '週日傍晚公司門口或社區管理室面交。', '{"seller":"阿姨菜園 / 手作小安","visibility":"circle_only","fulfillment":"pickup"}'::jsonb, now()),
  ('44444444-4444-4444-8444-444444444006', '22222222-2222-4222-8222-222222222203', 'interest_check', '11111111-1111-4111-8111-111111111111', NULL, '週末電影或免費票券意願調查', '朋友臨時有幾張電影票，先問圈內誰有興趣。人數夠再正式約時間或分配票券。', 'open', '2026-07-02 22:00:00+08', 'pg-interest-demo', '目前只是意願調查，暫不收款。', '若確定成行，會在公告中通知集合時間或取票方式。', '{"stage":"interest","examples":["看電影","吃飯","看球賽","免費票券"]}'::jsonb, now())
ON CONFLICT (id) DO UPDATE
